...
\begin{document}
	...
	The backend was implemented using Python Azure Functions. This was a logical choice because it integrates naturally with other Azure services already used by the project, including Azure SQL and Azure Blob Storage, and provides an easy way to expose function-based APIs for the frontend.
