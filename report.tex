...
\begin{document}
    ...
    \begin{figure}[htbp]
        ...
        \begin{tikzpicture}
            ...
            \addplot[fill=red!50,    draw=red!70]    coordinates {(46.67,small)};
            \addplot[fill=orange!60, draw=orange!80] coordinates {(90.98,gpt5few)};
            \addplot[fill=green!50,  draw=green!70]  coordinates {(95.30,gpt5ai)};
            \addplot[fill=blue!40,   draw=blue!60]   coordinates {(100,claude)};
            \end{axis}
        \end{tikzpicture}
