...
\begin{document}
    ...
    \begin{figure}[htbp]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Tagging accuracy by model on the first prompt version. Input token costs: MiniMax~M2.5 \$0.15/M, GPT-4o-mini \$0.15/M, GLM-5~Turbo \$1.20/M, Claude~Sonnet~4.6 \$3.00/M.}
